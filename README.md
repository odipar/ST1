...
| [jx1_68000_opt7.S](68k/jx1_68000_opt7.S) | 358 | 15 | opt6 with `get_gamma` unrolled into a ladder: the first three continuation/data pairs run straight-line with early exits (no 10-cycle back-jump per pair); long values fall into the loop tail | +2.9–3.7% over opt6 on parse-heavy data, +0.9–1.6% text, ~+0.2% copy-dominated |
